  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (user) {
        ...
        const logData = {
          id: `login-${Date.now()}`, // Unique ID for the log entry
          userId: user.userId,
          username: email,
          role: user.role,
          action: "login",
        ...
        // Navigate to appropriate dashboard based on user role or requested page
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 to-purple-600 p-6">
      <div className="bg-white shadow-lg rounded-xl p-8 w-full max-w-md transform transition duration-300 hover:scale-105">
        ...
        <div className="flex justify-center mt-6">
          <button
            onClick={() => navigate("/login", { state: { role: role === "admin" ? "user" : "admin" } })}
            className="flex items-center justify-center px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-md transition duration-200"
